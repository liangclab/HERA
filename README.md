...
# Installation
Assume the software HERA is under directory HERA. Please download HERA.zip and  All the executable files of HERA package should be put in HERA/bin. Please note that the running of pipeline.sh needs executables in HERA.zip file.
