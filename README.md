...
It is important to note that even though HERA can be used to improve the sequence contiguity of highly heterozygous genomes, it require HiC data (and better also with BioNano data) to resolve the haplotype sequences. A new pipeline to do this is being developed but is not included here.
...
perl $Working_Script/readstoline.pl $genome_seq $genome_name-Genome.fasta C

#split the sequences into two files with large contigs and small contigs
perl $Working_Script/01-Filter_Raw_Contig_By_Length.pl $genome_name-Genome.fasta Large_Contig.fasta Small_Contig.fasta 150000 15000
#covert the fasta formate to lines
perl $Working_Script/readstoline.pl $Corrected_Pacbio $genome_name-CorrectedPacbio.fasta P
...
perl $Working_Script/03-fasta-splitter.pl --n-parts 100 ../Query_Merged.fasta
...
perl $Working_Script/05-Filtered_InterIncluded_Pacbio.pl ./02-Pacbio-Alignment/Total_Alignment.txt ./02-Pacbio-Alignment/InterIncluded_Pacbio.txt $InterIncluded_Identity $InterIncluded_Coverage $InterIncluded_Side


#Record the pacbio alignment of contig's head and end
perl $Working_Script/06-Extract_Contig_Head_Tail_Pacbio_Alignment.pl -Align=./02-Pacbio-Alignment/Total_Alignment.txt -MinIden=$MinIdentity -MinCov=$MinCoverage -HTLen=$InterIncluded_Side -MinLen=$MinLength

#Change the aligned positions into positive chain
perl $Working_Script/10-Switch_Locus_To_Positive.pl Contig_Head_Tail_Pacbio.txt ./04-Graphing/Contig_Head_Tail_Pacbio_Pos.txt
...
perl $Working_Script/07-extract_fasta_seq_by_name.pl ./02-Pacbio-Alignment/InterIncluded_Pacbio.txt ./Query_Merged.fasta ./02-Pacbio-Alignment/Both_Side_Pacbio.fasta

#Split the remained pacbio or contigs into parts
cd ./03-Pacbio-SelfAlignment
perl $Working_Script/03-fasta-splitter.pl --n-parts 30 ../02-Pacbio-Alignment/Both_Side_Pacbio.fasta
...
perl $Working_Script/11-PacbioAlignmentFilter.pl ./03-Pacbio-SelfAlignment/Total_SelfAlignment.txt $MaxOverhang_Overlap $MinIdentity_Overlap $MinOverlap_Overlap $MinExtend_Overlap > ./04-Graphing/PacbioAlignmentFiltered.txt

#Find the proper overlap for constructing the graph
perl $Working_Script/12-PacbioAlignmentLinker.pl ./04-Graphing/PacbioAlignmentFiltered.txt $MaxOverhang_Overlap $MinExtend_Overlap > ./04-Graphing/PacbioAlignmentLinked.txt
...
perl $Working_Script/Selected_Best_Pairs.pl PacbioAlignmentLinked.txt PacbioAlignmentLinked_BestMatch.txt
perl $Working_Script/13-Graph_By_Finding_Best_MaxExtending_Random_Path.pl PacbioAlignmentLinked_BestMatch.txt >check
...
perl $Working_Script/14-make_ctg_line.pl cluster_ori_uniq.txt cluster_ori_same_chain.txt

perl $Working_Script/18-compute_fasta_file_len.pl ../Query_Merged.fasta Query_Len.txt

#Change the path into the same chain of bionano scaffolds
perl $Working_Script/15-make_junction_by_pos.pl ../04-Graphing/ctg_pairs.txt Query_Len.txt cluster_ori_same_chain.txt cluster_ori_same_chain_pos.txt

#Extract the aligned information of pacbios for final pathcontigs
perl $Working_Script/16-extract_ctg_infor_for_seq.pl cluster_ori_same_chain_pos.txt cluster_ori_same_chain_pos_for_seq.txt
echo ">NA" >NA.fasta
echo "ATCG" >>NA.fasta

#Output the final contigs of path used to fill the gap of bionano
perl $Working_Script/17-extract_seq_by_pos.pl cluster_ori_same_chain_pos_for_seq.txt ../Query_Merged.fasta NA.fasta PathContig.fasta

#Compute the length of pathcontigs
perl $Working_Script/18-compute_fasta_file_len.pl PathContig.fasta ../06-Daligner/PathContig_Len.txt
...
perl $Working_Script/03-Formate_Contig_Pairs_By_Paths.pl overlap.txt ../05-PathContig/ctg_clusters_uniq.txt Contig_Pairs.txt
...
perl $Working_Script/05-Merge_With_HighestScore_To_Sequence_By_Path.pl Contig_Pairs_Filtered.txt ../Large_Contig.fasta SuperContig.fasta >Selected_Pairs.txt
...
perl $Working_Script/19-Path2Scaffold_NoBioNano.pl ../10-Contig_Pairs/Selected_Pairs.txt ../05-PathContig/ctg_clusters_uniq.txt PathContig_Len.txt Path_Scaffold.txt

#rename the path contigs
perl $Working_Script/20-PathContig-Rename_NoBioNano.pl Path_Scaffold.txt ../05-PathContig/PathContig.fasta PathContig_Rename.fasta >log

perl $Working_Script/Rename1.pl ../10-Contig_Pairs/SuperContig.fasta  SuperContig_Rename.fasta >Rename_Pairs.txt
perl $Working_Script/Rename2.pl Rename_Pairs.txt PathContig_Rename.fasta PathContig_Rename2.fasta
mv -f PathContig_Rename2.fasta PathContig_Rename.fasta

#formating the connected scaffold
perl $Working_Script/01-Gap_Count.pl SuperContig_Rename.fasta $Enzyme Gap.txt
perl $Working_Script/01-Finding_Contigs_Gap.pl Gap.txt Scaffold2Ctg_Gap.txt
perl $Working_Script/02-Split_Scaffold_To_Contigs.pl SuperContig_Rename.fasta Prosudo_ScaffoldNonEnzyme2Contig.fasta $Enzyme
...
perl $Working_Script/22-Filling-Gap.pl Scaffold2Ctg_Gap.txt Prosudo_ScaffoldNonEnzyme2Contig.fasta PathContig_Rename.fasta SuperContig.fasta
...
The detailed usage is described in the man page available together with the source code. If you have questions about HERA, you may send the questions to huilongdu@genetics.ac.cn or cliang@genetics.ac.cn.
